...
If you are repeatedly seeing "404 Not Found" or "model not found" errors when using AI features, it means the specific model name the application is trying to use is not available for your API key. My apologies, my previous instructions incorrectly sent you to the Vertex AI Model Garden. The correct place to check is Google AI Studio.
...
1.  Once you are in Google AI Studio, look for an option to create a new prompt. Click on **"New prompt"** or a similar button.
...
2.  Click on this model name (it might say "Gemini 1.0 Pro" by default).
