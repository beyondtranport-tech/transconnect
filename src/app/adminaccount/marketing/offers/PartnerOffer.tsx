            ...
            <div className="grid md:grid-cols-2 gap-8">
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        <p>You earn a base commission of <strong className="text-primary">{isaMembershipShare}%</strong> on all membership and subscription fees from every member you bring into the network. This isn't a one-time payment; it's a recurring annuity for as long as they remain a member.</p>
