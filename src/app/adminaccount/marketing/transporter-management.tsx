...
import { Loader2, PlusCircle, Truck, Edit, Trash2, Send, Download, Save, Search, Filter, Users, Globe, Zap, Upload, RefreshCcw, Database, Tag, Sparkles, RotateCcw, UserCheck, ChevronDown, Settings2, Check } from 'lucide-react';
            ...
            <div className="space-y-6 text-left text-foreground">
                <CardHeader className="px-0 pt-0 flex flex-col md:flex-row md:items-center justify-between gap-4 text-left text-foreground">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-left text-foreground text-foreground text-foreground">
                        ...
                        <Button variant="outline" onClick={() => downloadDataAsCSV(filteredRecords, 'transporters-export.csv')} disabled={isLoading} className="text-left text-foreground"><Download className="mr-2 h-4 w-4" /> Export CSV</Button>
