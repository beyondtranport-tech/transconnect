...
import { Loader2, PlusCircle, Building, Edit, Trash2, Send, Copy } from 'lucide-react';
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 py-4 max-h-[80vh] overflow-y-auto pr-2">
            ...
            <DialogFooter className="pt-4 border-t">
              <Button type="submit" disabled={isLoading}>{isLoading ? <Loader2 className="animate-spin h-4 w-4" /> : null} Save Supplier</Button>
            </DialogFooter>
          </form>
        </Form>
      </DialogContent>
