...
import { Loader2, PlusCircle, Building, Edit, Trash2, Send, CheckCircle, Users, MailCheck, MailQuestion, Filter } from 'lucide-react';
  ...
  return (
    <>
      ...
      <AlertDialog open={dialog.type === 'delete'} onOpenChange={(o) => !o && setDialog({ type: null })}>
        <AlertDialogContent>
          <AlertDialogHeader><AlertDialogTitle>Delete Supplier?</AlertDialogTitle><AlertDialogDescription>Delete "{dialog.data?.firstName}"?</AlertDialogDescription></AlertDialogHeader>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div><CardTitle><Building /> Suppliers</CardTitle></div>
        ...
        <CardContent>
            ...
            {isLoading ? <div className="flex justify-center items-center py-10"><Loader2 className="animate-spin h-8 w-8 mx-auto text-primary" /></div> : <DataTable columns={columns} data={filteredSuppliers} />}
        </CardContent>
      </Card>
    </>
  );
