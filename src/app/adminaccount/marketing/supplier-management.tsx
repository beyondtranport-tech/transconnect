                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {step === 1 
                            ...
                            : "The outreach is logged. Send the link to the supplier now."}
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="space-y-6 py-6">
                        ...
                        <div className="flex justify-between gap-4">
                            <Button variant="outline" className="flex-1" asChild>
                                <Link href="/adminaccount?view=marketing-suppliers">Go to Pitch Library</Link>
                            </Button>
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                    <div>
                        ...
                        <CardDescription>Manage your supplier partners and assign platform owners.</CardDescription>
                    </div>
                    <div className="flex gap-2">
