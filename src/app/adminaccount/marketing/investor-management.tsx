...
import { Loader2, PlusCircle, DollarSign, Edit, Trash2, Send, Copy, MessageSquare, ClipboardList, MessageSquarePlus, CheckCircle } from 'lucide-react';
                ...
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {step === 1 
                            ...
                            : "The outreach is logged. Send the link to the investor now."}
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <div className="space-y-6 py-6">
                        ...
                        <div className="flex justify-between gap-4">
                            <Button variant="outline" className="flex-1" asChild>
                                <Link href="/adminaccount?view=marketing-investors">Go to Pitch Library</Link>
                            </Button>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-2xl">
            ...
            <DialogFooter className="pt-4 border-t">
                <Button onClick={form.handleSubmit(onSubmit)} disabled={isLoading}>{isLoading ? <Loader2 className="mr-2 h-4 w-4 animate-spin"/> : null} Save Investor</Button>
            </DialogFooter>
        </DialogContent>
    </Dialog>
  );
...
function InvestorActionMenu({ onInvite, onEdit, onDelete, partner, onUpdate }: { onInvite: () => void; onEdit: () => void; onDelete: () => void; partner: any; onUpdate: () => void; }) {
  return (
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Manage your investor partners and assign platform owners.</CardDescription>
          </div>
