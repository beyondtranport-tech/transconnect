...
import { Loader2, PlusCircle, DollarSign, Edit, Trash2, Send, Globe, Search, Download, Save, Filter, Users, UserCheck, Database, RotateCcw, Upload, Sparkles } from 'lucide-react';
            ...
            <Card className="bg-primary/5 border-primary/20 p-12 text-center text-foreground">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-4 max-w-4xl mx-auto text-left text-foreground text-foreground text-foreground">
                    ...
                    <div className="flex flex-col md:flex-row gap-2 self-end text-left text-foreground">
                        ...
                        <Button variant="outline" size="lg" onClick={() => { fetchData(); }} className="h-12 text-left text-foreground">
                             Show Recent
                        </Button>
                    </div>
                </div>
