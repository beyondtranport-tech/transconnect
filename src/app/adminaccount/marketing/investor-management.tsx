...
import { Loader2, PlusCircle, DollarSign, Edit, Trash2, Send, Globe, Search, Download, Save, Filter, Users, UserCheck, ChevronDown, Database, RotateCcw, ChevronLeft, ChevronRight, Sparkles, Upload } from 'lucide-react';
        ...
        cell: ({row}) => (
            <div className="flex flex-col text-left text-foreground">
                <span className="font-bold text-left text-foreground">
                    {row.original.companyName || <span className="text-destructive italic font-normal">Unnamed Entity</span>}
                </span>
