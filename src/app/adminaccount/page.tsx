...
function AdminAccountContent() {
  ...
  const initialView = searchParams.get('view') || 'leads-agent';
      ...
      <SidebarProvider>
        <Sidebar>
          ...
          <SidebarContent>
            <SidebarGroup>
                <SidebarMenuItem>
                    <SidebarMenuButton tooltip="AI Leads Agent" isActive={activeView === 'leads-agent'} onClick={() => navigate('leads-agent')}>
                        <Bot /><span>AI Leads Agent</span>
                    </SidebarMenuButton>
                </SidebarMenuItem>
                 <SidebarMenuItem>
                    <SidebarMenuButton tooltip="TTS Studio" isActive={activeView === 'tts-studio'} onClick={() => navigate('tts-studio')}>
                        <Mic /><span>TTS Studio</span>
                    </SidebarMenuButton>
                </SidebarMenuItem>
            </SidebarGroup>
          </SidebarContent>
