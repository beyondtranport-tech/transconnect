...
import { CheckCircle, ArrowRight, Fingerprint, Database, Zap, Scale, ShieldCheck, Globe, Banknote, Landmark, Store, Handshake, Award } from "lucide-react";
    ...
    <div className="bg-background text-left text-foreground">
        ...
        <section className="relative w-full h-64 md:h-96 bg-slate-950 text-white">
            ...
            <div className="relative h-full flex flex-col items-center justify-center text-center text-white z-10 p-4">
                ...
                <h1 className="text-4xl md:text-6xl font-black font-headline tracking-tight text-center text-white">Data Foundation. Transactional Engine.</h1>
        ...
        {/* SECTION 1: THE MAP (FORENSIC INTELLIGENCE) */}
        <section className="py-24 bg-white border-b">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div className="space-y-6 text-left">
                        <div className="bg-primary/10 p-4 rounded-2xl w-fit shadow-inner text-left"><Database className="h-10 w-10 text-primary"/></div>
                        ...
                        <div className="space-y-4 text-left text-foreground">
                            <div className="flex gap-4 items-start text-left text-foreground">
                                ...
                                <div className="text-left text-foreground">
                                    ...
                                    <p className="text-sm text-muted-foreground text-left text-foreground">Claim your existing record for R10/mo to verify your digital identity and manage your community reputation.</p>
                                </div>
                            </div>
                            <div className="flex gap-4 items-start text-left text-foreground">
                                ...
                                <div className="text-left text-foreground">
                                    ...
                                    <p className="text-sm text-muted-foreground text-left text-foreground">Unlock absolute transparency with direct contact details for 22,000+ verified transport and supply entities.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        {/* SECTION 2: THE ENGINE (TRANSACTIONAL EXECUTION) */}
        <section className="py-24 bg-slate-950 text-white border-b">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    <div className="md:order-2 space-y-6 text-left">
                        <div className="bg-primary/10 p-4 rounded-2xl w-fit shadow-inner text-left"><Scale className="h-10 w-10 text-primary"/></div>
                        ...
                        <div className="space-y-4 text-left text-white">
                            <div className="flex gap-4 items-start text-left text-white">
                                <Store className="h-6 w-6 text-primary shrink-0 mt-1" />
                                <div className="text-left text-white text-white">
                                    <p className="font-bold text-white">The Digital Branch</p>
                                    <p className="text-sm text-slate-400 text-left text-white">Create a commercial node on the grid to publish technical catalogs and receive matched RFQs.</p>
                                </div>
                            </div>
                            <div className="flex gap-4 items-start text-left text-white text-white">
                                ...
                                <div className="text-left text-white text-white">
                                    <p className="font-bold text-white">Passive Revenue Engine</p>
                                    <p className="text-sm text-slate-400 text-left text-white">The ISA framework allows top-performing members to earn recurring commissions on all network transactions.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        {/* SECTION 3: THE CURRENCY (REWARDS & CONTRIBUTIONS) */}
        <section className="py-24 bg-white text-center">
            <div className="container mx-auto px-4 text-left">
                <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
                    <h2 className="text-4xl font-black font-headline text-foreground text-center">Data as a Platform Currency</h2>
                ...
                <div className="grid md:grid-cols-3 gap-8 text-left text-foreground">
                    <Card className="bg-slate-50 border-none shadow-lg group hover:bg-primary transition-colors text-left text-foreground">
                        <CardContent className="p-8 space-y-4 text-left text-foreground text-foreground">
                            <Award className="h-10 w-10 text-primary group-hover:text-white" />
                            <h3 className="text-xl font-bold group-hover:text-white text-left">Earn While You Build</h3>
                            <p className="text-sm text-muted-foreground group-hover:text-white/80 leading-relaxed text-left text-foreground">Contribute verified fleet data or supplier lists to earn points that pay for your membership.</p>
                        </CardContent>
                    </Card>
                    <Card className="bg-slate-50 border-none shadow-lg group hover:bg-primary transition-colors text-left text-foreground text-foreground">
                        <CardContent className="p-8 space-y-4 text-left text-foreground text-foreground">
                            ...
                            <h3 className="text-xl font-bold group-hover:text-white text-left text-foreground">Direct Capital</h3>
                            <p className="text-sm text-muted-foreground group-hover:text-white/80 leading-relaxed text-left text-foreground">We use your real-world transactional data to fund your business where traditional banks fail.</p>
                        </CardContent>
                    </Card>
                    <Card className="bg-slate-50 border-none shadow-lg group hover:bg-primary transition-colors text-left text-foreground text-foreground">
                        <CardContent className="p-8 space-y-4 text-left text-foreground text-foreground">
                            <Landmark className="h-10 w-10 text-primary group-hover:text-white" />
                            <h3 className="text-xl font-bold group-hover:text-white text-left text-foreground">Reputation Nodes</h3>
                            <p className="text-sm text-muted-foreground group-hover:text-white/80 leading-relaxed text-left text-foreground">Build a verified track record in the community. Secure your identity and earn the trust of the grid.</p>
                        </CardContent>
                    </Card>
                </div>
