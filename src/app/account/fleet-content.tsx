                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                    <CardContent className="p-8 space-y-10 text-left">
                        ...
                        <div className="space-y-4">
                            <h3 className="font-bold flex items-center gap-2 text-lg text-foreground"><Truck className="h-5 w-5 text-primary" /> Powered Units</h3>
                        ...
                        {/* Trailers */}
                        <div className="space-y-4">
                            <h3 className="font-bold flex items-center gap-2 text-lg text-foreground"><ShieldCheck className="h-5 w-5 text-primary" /> Trailer Configurations</h3>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <p className="text-[10px] text-muted-foreground italic">Note: "Skeletal + Genset" is required to be matched for Refrigerated Container transport.</p>
                        </div>

                        {/* Regions */}
                        <div className="space-y-4">
                            <h3 className="font-bold flex items-center gap-2 text-lg text-foreground"><MapPin className="h-5 w-5 text-primary" /> Primary Operating Regions</h3>
                        ...
                        {/* Cargo Types */}
                        <div className="space-y-4">
                            <h3 className="font-bold flex items-center gap-2 text-lg text-foreground"><Package className="h-5 w-5 text-primary" /> Permissible Cargo</h3>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
