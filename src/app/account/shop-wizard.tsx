...
function StepWarehouseSecurity() {
    ...
    return (
        <div className="space-y-8 text-left text-foreground">
            <div className="text-left text-foreground">
                <h3 className="text-xl font-black font-headline flex items-center gap-2 text-left text-foreground text-foreground">
                    <Shield className="h-6 w-6 text-primary" />
                    Security & Access Protocol
                </h3>
                <p className="text-sm text-muted-foreground mt-1 text-left text-foreground text-foreground">Provide forensic clarity on how cargo is protected within your node.</p>
            </div>
    ...
    return (
        <div className="space-y-6 text-left text-foreground">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-left">
                ...
                <label className="aspect-square border-2 border-dashed rounded-xl flex flex-col items-center justify-center cursor-pointer hover:bg-muted/50 transition-colors text-center p-4 text-foreground text-foreground">
                    {uploading ? <Loader2 className="h-6 w-6 animate-spin text-primary" /> : <PlusCircle className="h-6 w-6 text-muted-foreground" />}
                    <span className="text-[10px] font-black uppercase mt-2 tracking-widest leading-tight text-center text-foreground">Add Photos</span>
    ...
    return (
        <div className="space-y-8 text-left text-foreground">
            ...
            <Card className="border-none bg-slate-50 shadow-inner text-left text-foreground">
                <CardContent className="p-6 text-left text-foreground text-foreground text-foreground">
                    ...
                    <div className="space-y-2 text-sm text-left text-foreground text-foreground">
...
function StepRateSheet() {
    ...
    return (
        <div className="space-y-8 text-left text-foreground text-foreground">
            <h3 className="text-xl font-black font-headline flex items-center gap-2 text-left text-foreground text-foreground text-foreground">
            ...
            {rateType === 'route' && (
                <div className="space-y-4 animate-in slide-in-from-top-2 text-left text-foreground text-foreground">
                    ...
                    <FormControl>
                        <RadioGroup onValueChange={field.onChange} value={field.value} className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left text-foreground">
                            <div className={cn("flex items-center space-x-3 p-4 border rounded-xl cursor-pointer", field.value === 'master' ? "bg-primary/5 border-primary" : "bg-white")}>
                                <RadioGroupItem value="master" id="c-master" /><Label htmlFor="c-master" className="cursor-pointer font-bold">Master Agreement <span className="block text-[10px] font-normal text-muted-foreground text-left text-foreground">Fixed volume per month.</span></Label>
                            </div>
                            <div className={cn("flex items-center space-x-3 p-4 border rounded-xl cursor-pointer", field.value === 'one_off' ? "bg-primary/5 border-primary" : "bg-white")}>
                                <RadioGroupItem value="one_off" id="c-spot" /><Label htmlFor="c-spot" className="cursor-pointer font-bold">One-Off Agreement <span className="block text-[10px] font-normal text-muted-foreground text-left text-foreground">Spot market bookings.</span></Label>
                            </div>
                        </RadioGroup>
                    </FormControl>
                </FormItem>
                        ...
                        {products.map(p => (
                            <Card key={p.id} className="overflow-hidden border-none shadow-md bg-white group text-left">
                                ...
                                <CardContent className="p-4 text-left">
                                    <p className="font-bold text-sm text-left text-foreground">{p.name}</p>
