                ...
                {currentStepConfig.id === 'main' && (
                    <div className="space-y-8 text-left animate-in fade-in duration-500">
                        ...
                        <div className="p-8 bg-slate-900 text-white rounded-[2rem] shadow-xl space-y-4 text-left">
                            <h4 className="text-[10px] font-black uppercase text-primary flex items-center gap-2 text-left"><User className="h-4 w-4" /> Principal Identity Node</h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                            <div className="space-y-6 text-left">
                                ...
                                {watchedValues.vatRegistered && (
                                    <FormField control={methods.control} name="vatNumber" render={({ field }) => (<FormItem className="text-left animate-in fade-in slide-in-from-left-2"><FormLabel>VAT Number</FormLabel><FormControl><Input {...field} value={field.value || ''} className="h-11 border-2 font-mono bg-white" /></FormControl></FormItem>)} />
                                )}
                            </div>
                ...
                {currentStepConfig.id === 'review' && (
                    <div className="text-center py-24 space-y-6 animate-in zoom-in-95 duration-700 text-left text-foreground">
                        ...
                        <div className="space-y-2 text-center text-foreground">
                            <h3 className="text-3xl font-black uppercase text-center text-foreground">Protocol Verified</h3>
