 ...
 * Re-structured for the new "Intelligence, Transaction, Data" model.
 */
export default function InvestorOffer() {
    return (
        <div className="space-y-12 text-left text-foreground">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center text-left">
                ...
                <Card className="bg-slate-900 text-white border-none p-10 rounded-[3rem] shadow-2xl text-left">
                    ...
                    <CardContent className="p-0 space-y-6 text-left">
                        ...
                        <p className="text-xs text-slate-500 leading-relaxed italic pt-4">
            ...
            <CardFooter className="bg-slate-50 border-t p-12 rounded-[2rem] flex flex-col md:flex-row justify-between items-center gap-8">
                <div className="text-left">
                    <h4 className="text-xl font-black uppercase">Ready for a Deep Dive?</h4>
                    <p className="text-muted-foreground">Access our complete 48-month data valuation model.</p>
                </div>
