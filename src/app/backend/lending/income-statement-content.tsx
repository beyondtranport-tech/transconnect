        ...
        <Card className="relative">
            ...
            <CardContent className="space-y-4">
                 <div className="space-y-2">
                    ...
                    <Input id={`incomeStatements.${index}.statementDate`} type="date" />
                </div>
                <div className="space-y-2">
                    <Label>Revenue</Label><Input type="number" placeholder="0.00" />
                    <Label>Cost of Sales</Label><Input type="number" placeholder="0.00" />
                    <p className="flex justify-between font-semibold"><span>Gross Profit</span><span>R 0.00</span></p>
                </div>
                <Separator />
                <div className="space-y-2">
                    <Label>Other Income</Label><Input type="number" placeholder="0.00" />
                    <Label>Operating Expenses</Label><Input type="number" placeholder="0.00" />
                    <p className="flex justify-between font-semibold"><span>Operating Profit</span><span>R 0.00</span></p>
                </div>
                <Separator />
                 <div className="space-y-2">
                    <Label>Finance Costs</Label><Input type="number" placeholder="0.00" />
                    <p className="flex justify-between font-semibold"><span>Profit Before Tax</span><span>R 0.00</span></p>
                </div>
                 <Separator />
                  <div className="space-y-2">
                    <Label>Income Tax Expense</Label><Input type="number" placeholder="0.00" />
