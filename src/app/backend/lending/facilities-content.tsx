            ...
            <CardContent className="space-y-6">
                ...
                {productType && (
                    <div className="pt-6 border-t">
                        ...
                        {(agreementType === 'loans' || agreementType === 'installment-sale' || agreementType === 'rental') && (
                            <div className="mt-4 space-y-4 max-w-2xl">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="agreement-type-display-loan">Agreement Type</Label>
                                        <Input id="agreement-type-display-loan" value={agreementType === 'loans' ? "Loan" : agreementType === 'installment-sale' ? "Instalment Sale" : "Lease"} disabled />
                                    </div>
                                    <div className="space-y-2">
                        ...
                        {agreementType !== 'discounting' && agreementType !== 'loans' && agreementType !== 'installment-sale' && agreementType !== 'rental' && (
