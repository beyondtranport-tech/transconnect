...
const FundingDivisionContent = dynamic(() => import('../adminaccount/funding-division-content'), { loading: () => <Loader2 className="h-16 w-16 animate-spin text-primary mx-auto my-20" /> });
