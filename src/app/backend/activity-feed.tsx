    ...
    return (
        <div className="space-y-8">
            <CardHeader className="px-0">
                ...
                <CardDescription>A real-time overview of all significant actions performed on the platform.</CardDescription>
            </CardHeader>
             {logs.length > 0 ? (
                                        ...
                                        <div className="flex justify-between items-start">
                                         ...
                                         <div className="flex items-center gap-2">
                                            <Button asChild variant="outline" size="sm">
                                                <Link href={`/backend?view=wallet&memberId=${log.companyId}`}>View Member</Link>
                                            </Button>
                                            <Button asChild variant="outline" size="sm">
                ...
                <div className="text-center py-20 border-2 border-dashed rounded-lg">
                    ...
                    <p className="mt-2 text-muted-foreground">Recent platform activities will appear here as they happen.</p>
                </div>
            )}
        </div>
    );
